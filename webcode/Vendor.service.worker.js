...
/** @type {string} */
const CACHE_VERSION = '1735072840|1402263652';
/** @type {string} */
const CACHE_PREFIX = 'Vendor-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Vendor.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Vendor.html","Vendor.js","Vendor.offline.html","Vendor.worker.js","Vendor.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["Vendor.wasm","Vendor.pck"];
